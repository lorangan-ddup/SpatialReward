#!/bin/bash
# EditReward-Bench Evaluation Script
...
echo "=============================================="
echo "EditReward-Bench Evaluation"
...
eval ${CMD} 2>&1 | tee -a logs/editreward.log
...
python calculate_accuracy.py \
    --result_file ${OUTPUT_DIR}/results.json 2>&1 | tee -a logs/editreward_stats.log
...
echo "   - statistics_report.json: Evaluation metrics"
echo "=============================================="
